...
from eqconstraint_xdipole_spherical_domain import get_real_RgNM_l_coeffs_for_plusz_xdipole_field


def get_sphere_planewave_plusz_xdipole_screening_datalists_numpy(k, dist, Ro, Rd_Plist, chi, xdfac,
    ...
    """
    computes the physics datalists needed for computing bounds on screening of an plusz xdipole field
    ...
    while True:
        ...
        #####calculate the coefficients for Si, including the planewave and the plusz_xdipole wave####
        np.seterr(under='warn')
        #the planewave
        ...
        xd_coeffs = xdfac * np.array(get_real_RgNM_l_coeffs_for_plusz_xdipole_field(l,k,Rall_list[-1]+dist, wig_1llp1_000, wig_1llm1_000, wig_1llp1_1m10, wig_1llm1_1m10))
        ...
        if l>2 and xd_sosqr<xd_sumnorm*normtol and pl_spherenorm-pl_sumnorm<normtol*pl_spherenorm:
            #break when both the planewave and plusz_xdipole norm summation tolerances have been met
            break
...
def get_sphere_planewave_plusz_xdipole_screening_numpy(k, dist, Ro, Rd_Plist, chi, xdfac,
                                                 Silist, Salist, Olist, Gmat_od_list, Po_list,
                                                 Plistlist, UPlistlist, Rgnormlistlist, subbasis_indlistlist, 
                                                 wig_1llp1_000,wig_1llm1_000, wig_1llp1_1m10,wig_1llm1_1m10, 
    ...
    mp.dps=mpdps
    klim_update = get_sphere_planewave_plusz_xdipole_screening_datalists_numpy(k, dist, Ro, Rd_Plist, chi, xdfac,
                                                 Silist, Salist, Olist, Gmat_od_list, Po_list,
                                                 Plistlist, UPlistlist, Rgnormlistlist, subbasis_indlistlist, 
                                                 wig_1llp1_000,wig_1llm1_000, wig_1llp1_1m10,wig_1llm1_1m10, 
...
def get_sphere_planewave_plusz_xdipole_equalnorm_screening_numpy(k, dist, Ro, Rd_Plist, chi, 
                                                 Silist, Salist, Olist, Gmat_od_list, Po_list,
                                                 Plistlist, UPlistlist, Rgnormlistlist, subbasis_indlistlist, 
                                                 wig_1llp1_000,wig_1llm1_000, wig_1llp1_1m10,wig_1llm1_1m10, 
                                                 initLags=None, incPIm=False, incRegions=None, incCross=True,
    ...
    #np.seterr(all='raise')
    mp.dps=mpdps
    klim_update = get_sphere_planewave_plusz_xdipole_screening_datalists_numpy(k, dist, Ro, Rd_Plist, chi, 1.0,
                                                 Silist, Salist, Olist, Gmat_od_list, Po_list,
                                                 Plistlist, UPlistlist, Rgnormlistlist, subbasis_indlistlist, 
                                                 wig_1llp1_000,wig_1llm1_000, wig_1llp1_1m10,wig_1llm1_1m10, 
                                                 mpdps=mpdps, normtol=normtol, gridpts=gridpts, maxveclim=maxveclim, Minitklim=Minitklim, Ninitklim=Ninitklim, Taylor_tol=Taylor_tol, Unormtol=Unormtol)
...
def sweep_norm_remainder_spherical_planewave_plusz_xdipole_equalnorm_screening_varydist(k, distlist, Ro, Rd_Plist, chi, 
    ...
    for i in range(len(distlist)):
        ...
        try:
            if (not feedforward) or (Lags is None):
                ...
                Lags, totdual, totobj, totnormsqrratio, dual1, dual2, Si1normsqr, Si2normsqr, normsqrratio1, normsqrratio2, klim = get_sphere_planewave_plusz_xdipole_equalnorm_screening_numpy(k, dist, Ro, Rd_Plist, chi, 
