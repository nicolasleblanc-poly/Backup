...
def get_TM_dipole_Prad_bound(chi, wvlgth, design_x, design_y, vacuum_x, vacuum_y, dist, pml_sep, pml_thick, gpr, NProjx, NProjy, opttol=1e-2, fakeSratio=1e-2, iter_period=20):
