...
function Dual(x,g,fSlist, tsolver, ei, ei_tr, chi_invdag, Gdag, Pv, get_grad)
...
lsolvers=Dict("val"=>val, "item"=>cg_solve, "nomad"=>bicgstab_solve)
function lsolverpick(name, x) 
    return lsolvers[name](x)
end
x=2
print(lsolverpick("val", x))
