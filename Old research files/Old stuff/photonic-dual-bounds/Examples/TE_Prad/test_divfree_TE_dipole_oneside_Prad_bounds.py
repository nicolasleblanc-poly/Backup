...
from get_TE_dipole_Prad_bounds import get_TE_dipole_oneside_Prad_divfree_bound
...
Prad_enh = get_TE_dipole_oneside_Prad_divfree_bound(chi, args.wavelength, args.orient, args.design_x, args.design_y, args.dist, args.pml_sep, args.pml_thick, args.gprx, args.gpry, args.NProjx, args.NProjy, divfree=divfree, alg=args.alg)
