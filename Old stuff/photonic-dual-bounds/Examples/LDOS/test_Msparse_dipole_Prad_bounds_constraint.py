...
import sys,argparse
#sys.path.append(path to photonic-dual-bounds directory here)

from get_Msparse_dipole_power_bounds_constraint import get_TM_dipole_Prad_Msparse_bound
...
Prad_enh = get_TM_dipole_Prad_Msparse_bound(chi, args.wavelength, args.design_x, args.design_y, args.vacuum_x, args.vacuum_y, args.dist, args.pml_sep, args.pml_thick, args.gpr, args.NProjx, args.NProjy)
